...
public class Ej2_AguilarTorres_FranciscoM {
	...
	public static void main(String[] args) {
		...
		System.out.println("Introduce el número del paciente [0-3]: ");
		int paciente= sc.nextInt();
		
		double media = examen.media_paciente(imcs_pacientes, paciente);
		System.out.printf("La media de ICM del paciente %d es: %.2f", paciente, media);
		sc.close();
	}
